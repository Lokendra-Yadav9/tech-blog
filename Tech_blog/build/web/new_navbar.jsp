    ...
    <head>
        ...
        <style>
            ...
            #searchResults{
                ...
                max-height: 300px; /* Example: Limit height to 300px */
                overflow-y: auto; /* Example: Add scrollbar if content exceeds max-height */
            }
            .result-item {
                margin-bottom: 10px;
                padding: 10px;
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-right">
                        <li class="nav-item">
                            <a class="nav-link" aria-disabled="true" href="#!" data-bs-toggle="modal" data-bs-target="#profile_Modal"> <span> <img style="width: 40px;height: 40px; object-fit: cover; border-radius: 50%; cursor: pointer;" class="img-fluid" title="<%= users.getName() %>" src="<%= imagePath%>" onclick="previewImage(this.src)" /></span> &nbsp;  <%= users.getName()%></a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="modal-dialog" style="transition: all 0.5s ease-in-out;">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="box-shadow: rgba(0,0,0,0.1);"></button>
                        ...
                        <form id="PostServletForm" action="AddPostServlet" method="post">
                            ...
                            <div class="mb-3 form-group">
                                <select class="form-control" name="categoryName" id="categorySelect">
                                    <option selected="true" disabled="true" class="my-2">---Select Categories---</option>
                                ...
                                <button class="tooltip-container text-light mt-2 offset-4" id="saveCateBtn" style="display: none;">
                                    ...
                                    <span class="texts text-light">Save category</span>
                                </button>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="box-shadow: rgba(0,0,0,0.1);">Close</button>
                    </div>
                </div>
            </div>
        </div>
